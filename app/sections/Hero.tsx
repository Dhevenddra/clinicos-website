  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col">
      ...
      <div className="flex-1 flex items-center">
        <div className="max-w-[1200px] w-full mx-auto px-6 md:px-10 lg:px-16 py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-14 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                className="mt-8 max-w-[52ch] text-lg text-[var(--color-ink-soft)] leading-relaxed"
              >
            ...
            >
              <HeroAscii className="aspect-[4/3] w-full" />
              {/* Subtle grounding glow below the panel */}
              <div
                aria-hidden
                className="pointer-events-none absolute -bottom-8 left-6 right-6 h-16 rounded-full blur-2xl opacity-40"
                style={{ background: "radial-gradient(60% 100% at 50% 0%, rgba(37,99,235,0.35), transparent)" }}
              />
            </motion.div>
          </div>
        </div>
